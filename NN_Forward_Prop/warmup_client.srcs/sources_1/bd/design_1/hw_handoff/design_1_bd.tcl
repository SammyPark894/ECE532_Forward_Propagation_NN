...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_noweights_0, and set properties
  set axi_noweights_0 [ create_bd_cell -type ip -vlnv utoronto.ca:user:axi_noweights:1.0 axi_noweights_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins axi_noweights_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net axi_noweights_0_AN [get_bd_ports AN] [get_bd_pins axi_noweights_0/AN]
  connect_bd_net -net axi_noweights_0_CA [get_bd_ports CA] [get_bd_pins axi_noweights_0/CA]
  connect_bd_net -net axi_noweights_0_CB [get_bd_ports CB] [get_bd_pins axi_noweights_0/CB]
  connect_bd_net -net axi_noweights_0_CC [get_bd_ports CC] [get_bd_pins axi_noweights_0/CC]
  connect_bd_net -net axi_noweights_0_CD [get_bd_ports CD] [get_bd_pins axi_noweights_0/CD]
  connect_bd_net -net axi_noweights_0_CE [get_bd_ports CE] [get_bd_pins axi_noweights_0/CE]
  connect_bd_net -net axi_noweights_0_CF [get_bd_ports CF] [get_bd_pins axi_noweights_0/CF]
  connect_bd_net -net axi_noweights_0_CG [get_bd_ports CG] [get_bd_pins axi_noweights_0/CG]
  connect_bd_net -net axi_noweights_0_DP [get_bd_ports DP] [get_bd_pins axi_noweights_0/DP]
  connect_bd_net -net axi_noweights_0_Om_out [get_bd_pins axi_noweights_0/Om_out] [get_bd_pins system_ila_0/probe16]
  connect_bd_net -net axi_noweights_0_copyIn_out [get_bd_pins axi_noweights_0/copyIn_out] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net axi_noweights_0_curResult_out [get_bd_pins axi_noweights_0/curResult_out] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net axi_noweights_0_f1Out_out [get_bd_pins axi_noweights_0/f1Out_out] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net axi_noweights_0_f2Out_out [get_bd_pins axi_noweights_0/f2Out_out] [get_bd_pins system_ila_0/probe5]
  connect_bd_net -net axi_noweights_0_lin_out0 [get_bd_pins axi_noweights_0/lin_out0] [get_bd_pins system_ila_0/probe6]
  connect_bd_net -net axi_noweights_0_lin_out1 [get_bd_pins axi_noweights_0/lin_out1] [get_bd_pins system_ila_0/probe7]
  connect_bd_net -net axi_noweights_0_lin_out2 [get_bd_pins axi_noweights_0/lin_out2] [get_bd_pins system_ila_0/probe8]
  connect_bd_net -net axi_noweights_0_lin_out3 [get_bd_pins axi_noweights_0/lin_out3] [get_bd_pins system_ila_0/probe9]
  connect_bd_net -net axi_noweights_0_lin_out4 [get_bd_pins axi_noweights_0/lin_out4] [get_bd_pins system_ila_0/probe10]
  connect_bd_net -net axi_noweights_0_lin_out5 [get_bd_pins axi_noweights_0/lin_out5] [get_bd_pins system_ila_0/probe11]
  connect_bd_net -net axi_noweights_0_lin_out6 [get_bd_pins axi_noweights_0/lin_out6] [get_bd_pins system_ila_0/probe12]
  connect_bd_net -net axi_noweights_0_lin_out7 [get_bd_pins axi_noweights_0/lin_out7] [get_bd_pins system_ila_0/probe13]
  connect_bd_net -net axi_noweights_0_lin_out8 [get_bd_pins axi_noweights_0/lin_out8] [get_bd_pins system_ila_0/probe14]
  connect_bd_net -net axi_noweights_0_lin_out9 [get_bd_pins axi_noweights_0/lin_out9] [get_bd_pins system_ila_0/probe15]
  connect_bd_net -net axi_noweights_0_selectedBias_out [get_bd_pins axi_noweights_0/selectedBias_out] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net axi_noweights_0_selectedWeight_out [get_bd_pins axi_noweights_0/selectedWeight_out] [get_bd_pins system_ila_0/probe1]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] [get_bd_pins axi_noweights_0/s00_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00200000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_noweights_0/S00_AXI/S00_AXI_reg] SEG_axi_noweights_0_S00_AXI_reg
